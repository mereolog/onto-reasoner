...
find_n_undecided_supermodules(
    cl_theory_folder='resources/inputs/bfo/src/common-logic/**/*.cl',
    cl_supermodule_folder='resources/midputs/supermodules/cl/',
    prepare_cl_theory=prepare_clif_bfo,
    parse_cl_theory=parse_clif,
    n=sys.maxsize,
    report_dict=dict(),
    report_file='resources/midputs/supermodules/bfo_supermodules_generation_report.xlsx')

...
_lr_productions = [
  ...
  ('extended_text -> texts','extended_text',1,'p_extended_texts','clif_parser.py',115),
  ('extended_text -> statements','extended_text',1,'p_extended_texts','clif_parser.py',116),
  ('extended_text -> sentences','extended_text',1,'p_extended_texts','clif_parser.py',117),
  ('texts -> text texts','texts',2,'p_texts','clif_parser.py',123),
  ('texts -> text','texts',1,'p_texts','clif_parser.py',124),
  ('text -> textconstruction','text',1,'p_text','clif_parser.py',139),
  ('text -> domainrestriction','text',1,'p_text','clif_parser.py',140),
  ('text -> importation','text',1,'p_text','clif_parser.py',141),
  ('text -> commenttext','text',1,'p_text','clif_parser.py',142),
  ('textconstruction -> OPEN TEXT constructed_texts CLOSE','textconstruction',4,'p_textconstruction','clif_parser.py',152),
  ('constructed_texts -> constructed_text constructed_texts','constructed_texts',2,'p_constructed_texts','clif_parser.py',159),
  ('constructed_texts -> constructed_text','constructed_texts',1,'p_constructed_texts','clif_parser.py',160),
  ('constructed_text -> sentence','constructed_text',1,'p_constructed_text','clif_parser.py',175),
  ('constructed_text -> statement','constructed_text',1,'p_constructed_text','clif_parser.py',176),
  ('constructed_text -> text','constructed_text',1,'p_constructed_text','clif_parser.py',177),
  ('statements -> statement statements','statements',2,'p_statements','clif_parser.py',184),
  ('statements -> statement','statements',1,'p_statements','clif_parser.py',185),
  ('statement -> titling','statement',1,'p_statement','clif_parser.py',200),
  ('statement -> discoursestatement','statement',1,'p_statement','clif_parser.py',201),
  ('statement -> OPEN COMMENT QUOTEDSTRING statement CLOSE','statement',5,'p_statement','clif_parser.py',202),
  ('discoursestatement -> indiscourse','discoursestatement',1,'p_discoursestatement','clif_parser.py',212),
  ('discoursestatement -> outdiscourse','discoursestatement',1,'p_discoursestatement','clif_parser.py',213),
  ('indiscourse -> OPEN INDISCOURSE terms CLOSE','indiscourse',4,'p_indiscourse','clif_parser.py',220),
  ('outdiscourse -> OPEN OUTDISCOURSE terms CLOSE','outdiscourse',4,'p_outdiscourse','clif_parser.py',227),
  ('domainrestriction -> OPEN RESTRICT term text CLOSE','domainrestriction',5,'p_domainrestriction','clif_parser.py',234),
  ('importation -> OPEN IMPORTS interpretablename CLOSE','importation',4,'p_importation','clif_parser.py',241),
  ('commenttext -> OPEN COMMENT QUOTEDSTRING texts CLOSE','commenttext',5,'p_commenttext','clif_parser.py',248),
  ('commenttext -> OPEN COMMENT QUOTEDSTRING prefixdeclarations texts CLOSE','commenttext',6,'p_commenttext','clif_parser.py',249),
  ('prefixdeclarations -> prefixdeclaration prefixdeclarations','prefixdeclarations',2,'p_prefixdeclarations','clif_parser.py',269),
  ('prefixdeclarations -> prefixdeclaration','prefixdeclarations',1,'p_prefixdeclarations','clif_parser.py',270),
  ('prefixdeclaration -> OPEN PREFIX QUOTEDSTRING interpretablename CLOSE','prefixdeclaration',5,'p_prefixdeclaration','clif_parser.py',285),
  ('titling -> OPEN TITLING interpretablename text CLOSE','titling',5,'p_titling','clif_parser.py',292),
  ('sentence -> atomsent','sentence',1,'p_sentence','clif_parser.py',299),
  ('sentence -> boolsent','sentence',1,'p_sentence','clif_parser.py',300),
  ('sentence -> existential_quantsent','sentence',1,'p_sentence','clif_parser.py',301),
  ('sentence -> universal_quantsent','sentence',1,'p_sentence','clif_parser.py',302),
  ('sentence -> commentsent','sentence',1,'p_sentence','clif_parser.py',303),
  ('atomsent -> equation','atomsent',1,'p_atomsent','clif_parser.py',310),
  ('atomsent -> atom','atomsent',1,'p_atomsent','clif_parser.py',311),
  ('boolsent -> and_sent','boolsent',1,'p_boolsent','clif_parser.py',318),
  ('boolsent -> or_sent','boolsent',1,'p_boolsent','clif_parser.py',319),
  ('boolsent -> if_sent','boolsent',1,'p_boolsent','clif_parser.py',320),
  ('boolsent -> iff_sent','boolsent',1,'p_boolsent','clif_parser.py',321),
  ('boolsent -> not_sent','boolsent',1,'p_boolsent','clif_parser.py',322),
  ('and_sent -> OPEN AND sentences CLOSE','and_sent',4,'p_and_sent','clif_parser.py',329),
  ('or_sent -> OPEN OR sentences CLOSE','or_sent',4,'p_or_sent','clif_parser.py',337),
  ('if_sent -> OPEN IF sentence sentence CLOSE','if_sent',5,'p_if_sent','clif_parser.py',345),
  ('iff_sent -> OPEN IFF sentence sentence CLOSE','iff_sent',5,'p_iff_sent','clif_parser.py',352),
  ('not_sent -> OPEN NOT sentence CLOSE','not_sent',4,'p_not_sent','clif_parser.py',359),
  ('commentsent -> OPEN COMMENT QUOTEDSTRING sentence CLOSE','commentsent',5,'p_commentsent','clif_parser.py',366),
  ('sentences -> sentence sentences','sentences',2,'p_sentences','clif_parser.py',374),
  ('sentences -> sentence','sentences',1,'p_sentences','clif_parser.py',375),
  ('equation -> OPEN EQUAL term term CLOSE','equation',5,'p_equation','clif_parser.py',390),
  ('atom -> OPEN term termseq CLOSE','atom',4,'p_atom','clif_parser.py',398),
  ('universal_quantsent -> OPEN FORALL OPEN bvar_list CLOSE sentence CLOSE','universal_quantsent',7,'p_universal_quantsent','clif_parser.py',412),
  ('existential_quantsent -> OPEN EXISTS OPEN bvar_list CLOSE sentence CLOSE','existential_quantsent',7,'p_existential_quantsent','clif_parser.py',426),
  ('bvar_list -> bvar bvar_list','bvar_list',2,'p_bvar_list','clif_parser.py',440),
  ('bvar_list -> bvar','bvar_list',1,'p_bvar_list','clif_parser.py',441),
  ('bvar -> interpretablename','bvar',1,'p_bvar','clif_parser.py',456),
  ('bvar -> cseqmark','bvar',1,'p_bvar','clif_parser.py',457),
  ('bvar -> OPEN interpretablename term CLOSE','bvar',4,'p_bvar','clif_parser.py',458),
  ('bvar -> OPEN cseqmark term CLOSE','bvar',4,'p_bvar','clif_parser.py',459),
  ('terms -> term terms','terms',2,'p_terms','clif_parser.py',466),
  ('terms -> term','terms',1,'p_terms','clif_parser.py',467),
  ('termseq -> termseq term','termseq',2,'p_termseq','clif_parser.py',482),
  ('termseq -> termseq SEQMARK','termseq',2,'p_termseq','clif_parser.py',483),
  ('termseq -> term','termseq',1,'p_termseq','clif_parser.py',484),
  ('termseq -> SEQMARK','termseq',1,'p_termseq','clif_parser.py',485),
  ('term -> name','term',1,'p_term','clif_parser.py',496),
  ('term -> OPEN term termseq CLOSE','term',4,'p_term','clif_parser.py',497),
  ('term -> OPEN COMMENT QUOTEDSTRING term CLOSE','term',5,'p_term','clif_parser.py',498),
  ('name -> interpretedname','name',1,'p_name','clif_parser.py',514),
  ('name -> interpretablename','name',1,'p_name','clif_parser.py',515),
  ('interpretedname -> NUMERAL','interpretedname',1,'p_interpretedname','clif_parser.py',522),
  ('interpretedname -> QUOTEDSTRING','interpretedname',1,'p_interpretedname','clif_parser.py',523),
  ('interpretedname -> OPEN COMMENT QUOTEDSTRING NUMERAL CLOSE','interpretedname',5,'p_interpretedname','clif_parser.py',524),
  ('interpretedname -> OPEN COMMENT QUOTEDSTRING QUOTEDSTRING CLOSE','interpretedname',5,'p_interpretedname','clif_parser.py',525),
  ('interpretablename -> NAMECHARSEQUENCE','interpretablename',1,'p_interpretablename','clif_parser.py',535),
  ('interpretablename -> ENCLOSEDNAME','interpretablename',1,'p_interpretablename','clif_parser.py',536),
  ('interpretablename -> OPEN COMMENT QUOTEDSTRING interpretablename CLOSE','interpretablename',5,'p_interpretablename','clif_parser.py',537),
  ('cseqmark -> SEQMARK','cseqmark',1,'p_cseqmark','clif_parser.py',547),
  ('cseqmark -> OPEN COMMENT QUOTEDSTRING SEQMARK CLOSE','cseqmark',5,'p_cseqmark','clif_parser.py',548),
]
